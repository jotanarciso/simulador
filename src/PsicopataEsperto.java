...
public class PsicopataEsperto extends Personagem {
    private Personagem alvo;

    public PsicopataEsperto(int linInicial,int colInicial){
    ...
    private Personagem defineAlvo(){
        ...
        for(int l=0;l<Jogo.NLIN;l++){
            for(int c=0;c<Jogo.NCOL;c++){
                ...
                if (p != null && p instanceof Jornalista && !p.infectado()){
                    alvo = p;
    ...
    public void atualizaPosicao() {
        ...
        // Pega posicao atual do PsicopataEsperto
                ...
                if (l>=0 && l<Jogo.NLIN && c>=0 && c<Jogo.NCOL){
                    ...
                    if (!( lin == l && col == c)){
                        ...
                        if (p != null){
                           ...
                           // if(chanceInfectar().inf>=0 && chanceInfectar().inf<=18) 
                                p.infecta();
                         //   else if(chanceMatar().mat >=19 && chanceMatar().mat<=20)
                          //      p.diminuiEnergia(0);
                        }
                    }
                }
